...
abstract class TestFirebaseStorageHostApi {
  ...
  Future<String> referenceStreamData(PigeonStorageFirebaseApp app, PigeonStorageReference reference, int maxSize, int handle);
  ...
  static void setup(TestFirebaseStorageHostApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.firebase_storage_platform_interface.FirebaseStorageHostApi.referenceStreamData', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, null);
      } else {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.firebase_storage_platform_interface.FirebaseStorageHostApi.referenceStreamData was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final PigeonStorageFirebaseApp? arg_app = (args[0] as PigeonStorageFirebaseApp?);
          assert(arg_app != null,
              'Argument for dev.flutter.pigeon.firebase_storage_platform_interface.FirebaseStorageHostApi.referenceStreamData was null, expected non-null PigeonStorageFirebaseApp.');
          final PigeonStorageReference? arg_reference = (args[1] as PigeonStorageReference?);
          assert(arg_reference != null,
              'Argument for dev.flutter.pigeon.firebase_storage_platform_interface.FirebaseStorageHostApi.referenceStreamData was null, expected non-null PigeonStorageReference.');
          final int? arg_maxSize = (args[2] as int?);
          assert(arg_maxSize != null,
              'Argument for dev.flutter.pigeon.firebase_storage_platform_interface.FirebaseStorageHostApi.referenceStreamData was null, expected non-null int.');
          final int? arg_handle = (args[3] as int?);
          assert(arg_handle != null,
              'Argument for dev.flutter.pigeon.firebase_storage_platform_interface.FirebaseStorageHostApi.referenceStreamData was null, expected non-null int.');
          final String output = await api.referenceStreamData(arg_app!, arg_reference!, arg_maxSize!, arg_handle!);
          return <Object?>[output];
        });
      }
    }
